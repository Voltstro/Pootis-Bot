...
namespace Pootis_Bot.Helpers
{
	...
	public static class StringExtensions
	{
		...
		private static readonly Regex EmojiRegex = new Regex(EmojiPattern, RegexOptions.Compiled);
		...
		/// <summary>
		/// Checks if a string contains only ONE emoji
		/// </summary>
		/// <param name="input"></param>
		/// <returns></returns>
		public static bool ContainsOnlyOneEmoji(this string input)
		{
			...
			//The match exactly matches the input
