...
public class DmChat
{
    ...
    public async Task<IUserMessage> SendMessage(string message)
    {
        ...
        {
            Log.Warning("An HttpException was thrown while trying to send a user a message, they might not allow DMs.");
            throw;
        }
        catch (Exception ex)
        {
            Log.Error(ex, "An unknown error was thrown while trying to send a user a message!");
            throw;
        }
    }
