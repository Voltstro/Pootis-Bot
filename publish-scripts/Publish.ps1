...
Compress-Archive -Path ("..\src\Pootis-Bot\Bin\Release\" + $framework + "\" + $rid + "\publish\*") -DestinationPath "..\src\Pootis-Bot\bin\Release\pootis-bot-win-x64.zip" -CompressionLevel Optimal -Force